...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "SELECT username, password FROM studenttt WHERE username = '$username' and password = '$password'";
...
<body>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div class="text-end">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                        <li>
                            <a class="dropdown-item active" href="../src/student-login.php">Student Login</a>
                        </li>
                        <li>
    ...
    <div class="container mt-4">
        <h1 style="text-align:center; padding-bottom: 30px;">Student Login</h1>
        <hr>
        <form class="row g-3" action="" method="post">
            ...
            <div class="col-12">
                <button class="btn btn-secondary" onclick="document.location='student-registration.php'">Register as an Student!</button>
            </div>
        </form>
    </div>
