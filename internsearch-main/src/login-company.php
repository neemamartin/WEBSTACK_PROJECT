...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "SELECT c_id, c_password FROM company_reg WHERE c_id = '$username' and c_password = '$password'";
...
<body>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div class="text-end">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li>
                            <a class="dropdown-item active" href="../src/login-company.php">Company Login</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container mt-4 col-lg-6 mx-auto">
        <h1 style="text-align:center; padding-bottom: 30px;">Company Login</h1>
        <hr>
